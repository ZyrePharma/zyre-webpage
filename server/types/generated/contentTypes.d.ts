...
export interface ApiAboutZyreAboutZyre extends Struct.SingleTypeSchema {
  collectionName: 'about_zyres';
  info: {
    displayName: 'About Zyre';
    pluralName: 'about-zyres';
    singularName: 'about-zyre';
  };
  options: {
...
export interface ApiCompanyGalleryCompanyGallery
  extends Struct.CollectionTypeSchema {
  collectionName: 'company_galleries';
  info: {
    displayName: 'Company Gallery';
    pluralName: 'company-galleries';
    singularName: 'company-gallery';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::company-gallery.company-gallery'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOfficeOffice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    officeHours: Schema.Attribute.Component<'office-hour.office-hours', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pharmaceutical products with detailed information';
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiSisterCompanySisterCompany
  extends Struct.CollectionTypeSchema {
  collectionName: 'sister_companies';
  info: {
    displayName: 'Sister Company';
    pluralName: 'sister-companies';
    singularName: 'sister-company';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sister-company.sister-company'
    > &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    name: Schema.Attribute.String;
...
export interface ApiZyreTimelineZyreTimeline
  extends Struct.CollectionTypeSchema {
  collectionName: 'zyre_timelines';
  info: {
    displayName: 'Zyre Timeline';
    pluralName: 'zyre-timelines';
    singularName: 'zyre-timeline';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::zyre-timeline.zyre-timeline'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-zyre.about-zyre': ApiAboutZyreAboutZyre;
